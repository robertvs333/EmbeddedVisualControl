...
from jetson_camera.motorDrivers import hat
...
class DaguWheelsDriver:
    ...
    def __init__(self):
        ...
        self.leftSpeed = 0.0
        self.rightSpeed = 0.0 
        #self.driver_1 = WheelEncoderDriver(self.GPIO_MOTOR_ENCODER_1)
        #self.driver_2 = WheelEncoderDriver(self.GPIO_MOTOR_ENCODER_2)
